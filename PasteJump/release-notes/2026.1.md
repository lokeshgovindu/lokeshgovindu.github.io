...
Everything else in this release is described in the pre-release notes: [pre6](https://github.com/lokeshgovindu/PasteJump/releases/tag/2026.1-pre6) brought the working update check, update channels and the Credits window; [pre3](https://github.com/lokeshgovindu/PasteJump/releases/tag/2026.1-pre3) carried the bulk of the bug fixes.
